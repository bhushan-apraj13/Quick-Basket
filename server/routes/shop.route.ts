...
import { createShop, getShop, getShopOrder, getSingleShop, searchOrder, updateOrderStatus, updateShop } from '../controller/shop.controller';
...
router.route("/search/:searchText").get(isAuthenticated,searchOrder);
