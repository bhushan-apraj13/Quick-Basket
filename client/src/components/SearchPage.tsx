            ...
            <div className="flex flex-col md:flex-row justify-between gap-10">
                ...
                <div className="flex-1">
                    ...
                    <div className="flex items-center gap-2 mb-6">
                        ...
                        />
                        <Button onClick={()=> searchShop(params.text!, searchQuery)} className="bg-brandOrange text-white hover:bg-opacity-90 px-6 py-2 rounded-lg">Search</Button>
                    </div>
                    {/* Searched Products */}
                    <div>
                        <div className="flex flex-col gap-3 md:flex-row md:items-center md:gap-2 my-3">
                            <h1 className="text-lg font-medium">({searchedShop?.data.length}) Search results found</h1>
                                    ...
                                    !loading && searchedShop?.data.length === 0 ? (
                                        ...
                                        (
                                            searchedShop?.data.map((shop: Shop,) => (
                                                <Card key={shop._id} className="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden hover:shadow-lg transition-shadow duration-300">
                                                    ...
                                                    <CardContent className="p-4">
                                                        ...
                                                        <div className="mt-2 flex items-center text-gray-600 dark:text-gray-400">
                                                            ...
                                                            <p className="text-sm ml-1">
                                                                City: <span className="font-medium">{shop.cityName}</span>
                                                            </p>
                                                        </div>
    ...
    return (
        <div className="col-span-full flex flex-col items-center justify-center min-h-[50vh] text-center">
            <div>
                ...
                <Link to="/">
                    <Button className="mt-4 bg-brandOrange/90 hover:bg-brandOrange/80 text-white">
                        Back to Home
                    </Button>
                </Link>
            </div>
