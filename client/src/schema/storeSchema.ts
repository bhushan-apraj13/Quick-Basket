...
export const storeSchema = z.object({
    storeName: z.string().min(3, "Store name is too short").max(20, "Store name is too long"),
    address: z.string().min(6, "Address must be at least 6 characters").max(200, "Address must be at most 200 characters"),
    city: z.string().min(3, "City must be at least 3 characters").max(20, "City must be at most 50 characters"),
