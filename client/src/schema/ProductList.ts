...
export const ProductListSchema = z.object({
    title: z.string().min(5, "Product Name must be at least 5 characters").max(30, "Product Name must be less than 30 characters").regex(/^[A-Za-z\s]+$/, " / Product name must contain only letters and spaces"),
